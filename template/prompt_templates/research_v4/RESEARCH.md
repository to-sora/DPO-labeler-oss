# V4 Adult Prompt Research

This directory starts as a clone of the V3 prompt investigation set for the next amendment stage.
It does not replace the frozen V1 baseline under `prompt_templates/curated/`, and it leaves V3 untouched.
