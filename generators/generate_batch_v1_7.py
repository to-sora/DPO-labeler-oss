...
DEFAULT_OUTPUT_DIR = WORKFLOWS_DIR / "batch_v1_7"
DEFAULT_GLOBAL_SEED = 20260406
    ...
    for version_name, templates, args_builder in VERSION_TEMPLATE_BUILDERS:
        for template_name in templates:
            ...
            for pair_mode in ("same", "diff"):
                task_name = f"b17_{version_name}_{short}_{pair_mode}"
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Generate flat batch_v1_7 workflow YAMLs.")
...
def main() -> None:
    ...
    rows = generate_batch_v1_7(args.output_dir, global_seed=args.global_seed)
